...
## 맡은 역할
~~**요약** 네비게이션과 스택 세팅 / 꿈 기록 페이지 / 공통 컴포넌트 제작 / theme.js~~

### [ 네비게이션과 스택 세팅 ]

<div><img src=${eeumNav} alt='navigation' /></div>

- 사용자의 어플 이용 흐름을 고려하여 **Navigation과 Stack**을 쌓아 효율적인 페이지 이동의 구성을 만들었습니다.
- 보다 깔끔한 UI와 UX 제공을 위해 스택 헤더를 숨기고 화면 왼쪽 하단에 **네비게이션 버튼**을 구현하였습니다.
...
## 프로젝트 회고
- 처음 React Native를 이용하여 앱을 개발해본 좋은 기회가 된 프로젝트였습니다.

- 전체적으로 아쉬움이 많이 남는 프로젝트였다. 한 번에 여러가지 새로운 기술을 도입하려는 욕심에 모든 기술을 원하는대로 도입하지 못한 것이 아쉬웠다.
- 상태관리 라이브러리로 React Query를 사용해보고자 했으나, 프로젝트 기간이 짧아 기술 습득에 투자할 수 있는 시간이 적어 사용하지 못한것이 아쉬웠다.
